<?php
/********************************************************************************************
 * @name:       temp-avatar-download.php - part of jQuery script for creating vector avatars
 * @version:    1.6
 ...
 *
 * Force download of temporary avatars from the 'temp-avatars' directory
*********************************************************************************************/
...
// checking if file exist (means that it has been written successfully by temp-avatar-save.php earlier)
if ( file_exists( $file ) && $file !== '../temp-avatars/' ) {
    ...
    die( "Can't proceed downloading. Previously saved file does not exist." );
}
